...
// Iter QG5c1: env_awareness_low, active_data_driven_rule_labels,
// active_environmental_rule_labels, active_composite_rule_labels +
// LATE_NIGHT_* consts/static + late_night_wellness_* helpers
// extracted to `proactive/prompt_rules.rs`. Re-exported via glob above.
...
mod gate_tests {
    ...
    // in_quiet_hours pure-helper tests moved to proactive/time_helpers.rs
    // (Iter QG5c-prep). Gate-integration tests below stay — they exercise
    // evaluate_pre_input_idle's interaction with quiet_hours.
