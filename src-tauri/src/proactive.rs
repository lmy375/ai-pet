...
// Iter QG5: reminder parsing/due/staleness/format helpers extracted to
// `proactive/reminders.rs`. Re-exported below so external callers
// (`consolidate.rs`, panel commands) keep using `crate::proactive::...`.
