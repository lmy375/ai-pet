...
- [ ] Iter 96：把 ToneSnapshot.active_prompt_rules 的"心电图"派生数据（restraint count / engagement count / dominant tilt）也走 process_counters atomic 累计，让 panel 显示"今日 prompt 平均倾斜度"——用户能看到长期 prompt 是被引导主导还是克制主导。
