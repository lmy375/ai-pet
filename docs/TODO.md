...
- ChatMini bubble 右键加「📋 复制 thread 5」：复制本 bubble 之上 5 条（含本条）拼 markdown — 上下文段 audit 入口。
...
- PanelDebug 加「📋 复制 cron 配置」chip：一键复制 interval / enabled / min_total_items 配置为 markdown — 配 issue 用。
